//REVIEW Names (array of name values and functions to select random value)
...
// REVIEW Functions for random numbers and characters
...
// REVIEW Mobile Number Generator
...
//REVIEW: Generate account number
...
function generateWorkType() {
    getworkType = Math.floor(Math.random() * workType.length);
    let generatedworkType = workType[getworkType];
    document.getElementById("worktype").value = generatedworkType;
}

function copyWorkType() {
    var copyText = document.getElementById("worktype");
    copyText.select();
    copyText.setSelectionRange(0, 99999)
    document.execCommand("copy");
}
...
//     document.getElementById("container1").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading1").style.color = "#000";
//     document.getElementById("container2").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading2").style.color = "#000";
//     document.getElementById("container3").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading3").style.color = "#000";
//     document.getElementById("container4").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading4").style.color = "#000";
//     document.getElementById("container5").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading5").style.color = "#000";
//     document.getElementById("container6").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading6").style.color = "#000";
//     document.getElementById("container7").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading7").style.color = "#000";
//     document.getElementById("container8").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading8").style.color = "#000";
//     document.getElementById("container9").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading9").style.color = "#000";
//     document.getElementById("container10").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading10").style.color = "#000";
//     document.getElementById("container11").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading11").style.color = "#000";
//     document.getElementById("container12").style.backgroundColor = "#f5f6f8";
//     document.getElementById("heading12").style.color = "#000"; 
// }

function darkmode() {
    var element = document.body;
    element.classList.toggle("light-mode");
    document.getElementById("container1").style.backgroundColor = "#fff";
    document.getElementById("heading1").style.color = "#000";
    document.getElementById("container2").style.backgroundColor = "#fff";
    document.getElementById("heading2").style.color = "#000";
    document.getElementById("container3").style.backgroundColor = "#fff";
    document.getElementById("heading3").style.color = "#000";
    document.getElementById("container4").style.backgroundColor = "#fff";
    document.getElementById("heading4").style.color = "#000";
    document.getElementById("container5").style.backgroundColor = "#fff";
    document.getElementById("heading5").style.color = "#000";
    document.getElementById("container6").style.backgroundColor = "#fff";
    document.getElementById("heading6").style.color = "#000";
    document.getElementById("container7").style.backgroundColor = "#fff";
    document.getElementById("heading7").style.color = "#000";
    document.getElementById("container8").style.backgroundColor = "#fff";
    document.getElementById("heading8").style.color = "#000";
    document.getElementById("container9").style.backgroundColor = "#fff";
    document.getElementById("heading9").style.color = "#000";
    document.getElementById("container10").style.backgroundColor = "#fff";
    document.getElementById("heading10").style.color = "#000";
    document.getElementById("container11").style.backgroundColor = "#fff";
    document.getElementById("heading11").style.color = "#000";
    document.getElementById("container12").style.backgroundColor = "#fff";
    document.getElementById("heading12").style.color = "#000"; 
}